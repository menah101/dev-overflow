...
const StatsCark = ({ imgUrl, value, title }: StatsCardProps) => {
  return (
  ...
  return (
    <div className="mt-10">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 xs:grid-cols-2 md:grid-cols-4">
        ...
        <StatsCark imgUrl="/assets/icons/gold-medal.svg" value={0} title="Gold Badges" />

        <StatsCark imgUrl="/assets/icons/silver-medal.svg" value={0} title="Silver Badges" />

        <StatsCark imgUrl="/assets/icons/bronze-medal.svg" value={0} title="Bronze Badges" />
      </div>
    </div>
  );
};
